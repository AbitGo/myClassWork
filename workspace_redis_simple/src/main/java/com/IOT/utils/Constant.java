...
public class Constant {
    ...
    //修改以下两个参数，由电信平台提供.
    public static final String APPID = "OB1tsCOc05HBFgLW7Ixu0QTYnywa";
    public static final String SECRET = "ZPizGJWDmdm87CRyA0HQfLzLjRsa";
    //暂时储存的数据
     ...
     *请将这个url改成你的云服务器网址
     */
    public static final String CALLBACK_BASE_URL = "http://47.102.42.105:8181";
